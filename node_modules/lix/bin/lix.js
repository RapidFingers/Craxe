...
"/GbaawVQXxcESYBNDHqcwH8S/5p7PvQU6oeljp8mBOk=":
...
"/SCV0YtOW05WxzwfDzRpZSQykMev8frGiRIl11RE8oY=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"0CRR+jlt5/nsk8xvs7B6qnvmN6yzQJqd3r0cLeknnBo=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"1hEHzqCW0f4SGcuYOLi73dYiwpH3syuhBKAGydTrgX8=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"ApQJ//D6AEbulEgo12cZidunwPvpic++XygK95CHplQ=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"CXZ0DJE8sak06cRG9uFe/87z1zhwtNunjLYgG/YhJDs=":
function (require, module, exports, __dirname, __filename) {
'use strict'
const MiniPass = require('minipass')
...
"L/iVZDJoUd1JkmFWD5RtCYG58Kv9dya4v09oL0X0kXg=":
function (require, module, exports, __dirname, __filename) {
'use strict'
const Buffer = require('./buffer.js')
...
"Nzriz9I7hUI5sIc7p06YFt4VFmoowzWjSd/8OIwJmxA=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"ODI7/X5H4Kx03YRNE1AP0C20Grhdp4S19RqI6T8EHzs=":
function (require, module, exports, __dirname, __filename) {
'use strict'
const Buffer = require('./buffer.js')
const Header = require('./header.js')
...
"T3esGW7BBlxcs1qWoid3PkZndigFoZnF52BlBqCBx/g=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"Wt0NOvVXL7hkBqF4d+WViy5Ugm/wLvmEZAspzutJhOg=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"X+eMgsjGF3JsT9WmhA7az+2Y5uFfYmefsYUj7yci+bk=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"Y4o+neRkDJJmacmvfyUOyAeqm1s+C5llphMoOClcUmI=":
function (require, module, exports, __dirname, __filename) {
...
"ZOz+7NAJGnmZX0AhCbHZN8ixtpItEJV7aU42Ld9Xydk=":
function (require, module, exports, __dirname, __filename) {
...
haxeshim_Fs.delete = function(path) {
	if(sys_FileSystem.isDirectory(path)) {
		...
		if(sys_FileSystem.exists(path)) {
			var _g2 = 0;
			var _g11 = js_node_Fs.readdirSync(path);
			while(_g2 < _g11.length) {
				var file1 = _g11[_g2];
				++_g2;
				var curPath = path + "/" + file1;
...
haxeshim_HaxeCli.prototype = {
	installLibs: function(silent) {
		...
		var cmds = i.instructions.install;
		var _g11 = 0;
		while(_g11 < cmds.length) {
			var cmd = cmds[_g11];
			++_g11;
			if(!silent) {
			...
			var _g12 = haxeshim_Exec.shell(cmd,process.cwd());
			if(_g12._hx_index == 1) {
				var e = _g12.failure;
				code = e.code;
			}
		}
		var cmds1 = i.instructions.postInstall;
		var _g13 = 0;
		while(_g13 < cmds1.length) {
			var cmd1 = cmds1[_g13];
			++_g13;
			if(!silent) {
				process.stdout.write(Std.string(cmd1));
				process.stdout.write("\n");
			}
			var _g14 = haxeshim_Exec.shell(cmd1,process.cwd());
			if(_g14._hx_index == 1) {
				var e1 = _g14.failure;
				code = e1.code;
			}
...
haxeshim_Scope.prototype = {
			...
			if(StringTools.startsWith(line,"#")) {
				...
				if(StringTools.startsWith(content,"@")) {
					...
					if(_g2 != -1) {
						...
						var tmp;
						var _g3 = __map_reserved[name] != null ? ret.getReserved(name) : ret.h[name];
						if(_g3 == null) {
							var v1 = [];
	...
	,getLibCommand: function(args) {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(this.getDirectives(lib),function(d) {
			...
			if(_g == null) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"no @run directive found for library " + lib,{ fileName : "haxeshim/Scope.hx", lineNumber : 212, className : "haxeshim.Scope", methodName : "getLibCommand"}))));
			} else {
				switch(_g.length) {
				case 0:
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"no @run directive found for library " + lib,{ fileName : "haxeshim/Scope.hx", lineNumber : 212, className : "haxeshim.Scope", methodName : "getLibCommand"}))));
				case 1:
					...
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(function() {
						return haxeshim_Exec.shell(cmd3,cwd,env);
					})));
				default:
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"more than one @run directive for library " + lib,{ fileName : "haxeshim/Scope.hx", lineNumber : 217, className : "haxeshim.Scope", methodName : "getLibCommand"}))));
				}
			}
		});
	}
	,getInstallationInstructions: function() {
		...
		if(sys_FileSystem.exists(this.scopeLibDir)) {
			var _g = 0;
				...
				if(!sys_FileSystem.isDirectory(path) && StringTools.endsWith(path,".hxml")) {
					...
					while(pos < max) if(args[pos++] == "-cp") {
						...
						if(!sys_FileSystem.exists(cp)) {
							...
							var _g2 = __map_reserved["install"] != null ? dir.getReserved("install") : dir.h["install"];
							if(_g2 == null) {
								...
								var _g11 = __map_reserved["post-install"] != null ? dir.getReserved("post-install") : dir.h["post-install"];
								if(_g11 != null) {
									var v1 = _g11;
									var _g12 = 0;
									while(_g12 < v1.length) {
										var i1 = v1[_g12];
										++_g12;
	...
	while(_g < _g1.length) {
		...
		if(_g2 != null) {
			...
			case "-":
				...
				break;
			default:
				var _g4 = StringTools.trim(line);
				if(_g4 != "") {
					var v1 = _g4;
					var _g5 = 0;
					var _g11 = normalize(v1);
...
lix_cli_Cli.dispatch = function(args) {
	...
	var inlobj_name = "lix";
	var inlobj_description = "lix - Libraries for Haxe";
	var inlobj_repository_url = "git+https://github.com/lix-pm/lix.git";
	var inlobj_repository_type = "git";
	var inlobj_homepage = "https://github.com/lix-pm/lix#readme";
	var inlobj_devDependencies = { yauzl : "=2.6.0", noderify : "=3.0.2", tar : "^4.4.8", "graceful-fs" : "^4.1.15"};
	var inlobj_files_0 = "bin";
	var inlobj_version = "15.4.1";
	var inlobj_author = "back2dos";
	var inlobj_scripts_noderify = "noderify";
	var inlobj_scripts_prepublishOnly = "haxe --run Build";
	var inlobj_scripts_postinstall = "node bin/postinstall.js";
	var inlobj_scripts_build = "haxe --run Build";
	var inlobj_license = "MIT";
	var inlobj_bugs_url = "https://github.com/lix-pm/lix/issues";
	var inlobj_bin_haxe = "bin/haxeshim.js";
	var inlobj_bin_lix = "bin/lix.js";
	var inlobj_bin_haxelib = "bin/haxelibshim.js";
	var inlobj_bin_neko = "bin/nekoshim.js";
	...
	var resolve = function(url) {
		var key = url.scheme;
		var _g51 = __map_reserved[key] != null ? resolvers.getReserved(key) : resolvers.h[key];
		if(_g51 == null) {
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Unknown scheme in url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "src/lix/cli/Cli.hx", lineNumber : 48, className : "lix.cli.Cli", methodName : "dispatch"}))));
		} else {
			var v2 = _g51;
	...
	var libs = new lix_client_Libraries(scope,resolve,function(_1) {
		return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(501,"not implemented",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 59, className : "lix.cli.Cli", methodName : "dispatch"}))));
	},log,force,silent);
	...
	var this3 = new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("install"),"<url> [as <lib[#ver]>]","install lib from specified url",function(args3) {
		if(scope.isGlobal && !global1) {
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Current scope is global. Please use --global if you intend to install globally, or create a local scope with `lix scope create`.",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 70, className : "lix.cli.Cli", methodName : "dispatch"}))));
		} else {
			switch(args3.length) {
			case 0:
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Missing url",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 83, className : "lix.cli.Cli", methodName : "dispatch"}))));
			case 1:
				var _g52 = args3[0];
				var library = _g52;
			...
			case 2:
				...
				if(_g6 == "haxe") {
					...
					var lib = library1;
					return tink_core__$Promise_Promise_$Impl_$.next(this4,function(constraint1) {
			...
			case 3:
				if(args3[1] == "as") {
					...
					var v3 = args3;
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 84, className : "lix.cli.Cli", methodName : "dispatch"}))));
				}
				break;
			default:
				var v4 = args3;
	...
	var this8 = new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("use"),"haxe <alias>|<version>","use specified haxe version",function(args4) {
		if(args4.length == 2) {
			if(args4[0] == "haxe") {
				...
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid arguments",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 90, className : "lix.cli.Cli", methodName : "dispatch"}))));
			}
		} else {
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid arguments",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 90, className : "lix.cli.Cli", methodName : "dispatch"}))));
		}
	...
	var this10 = new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("scope"),"[create|delete]","creates or deletes the current scope or\ninspects it if no argument is supplied",function(args5) {
		...
		case 1:
			...
			case "delete":
				if(scope.isGlobal) {
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Cannot delete global scope",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 104, className : "lix.cli.Cli", methodName : "dispatch"}))));
				} else {
					scope.delete();
			...
			default:
				var v5 = args5;
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Invalid arguments",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 116, className : "lix.cli.Cli", methodName : "dispatch"}))));
			}
			break;
		default:
			var v6 = args5;
	...
	var this11 = new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("haxe-versions"),"","lists currently downloaded versions",function(args6) {
		if(args6.length == 0) {
			...
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"command `list` does expect arguments",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 153, className : "lix.cli.Cli", methodName : "dispatch"}))));
		}
	});
	var this12 = new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("download"),"[<url[#lib[#ver]]>]","download lib from url if specified,\notherwise download missing libs",function(args7) {
		...
		case 0:
			return tink_core__$Promise_Promise_$Impl_$.next(lix_client_haxe_Switcher.ensureNeko(Sys.println),function(_2) {
				...
				return tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.next(this13,function(version3) {
		...
		case 1:
			var url3 = tink__$Url_Url_$Impl_$.fromString(args7[0]);
		...
		case 2:
			if(args7[0] == "haxe") {
				...
				var v13 = args7;
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 198, className : "lix.cli.Cli", methodName : "dispatch"}))));
			}
			break;
		case 3:
			var _g10 = args7[2];
			...
			case "as":
				...
				if(sys_FileSystem.exists(absTarget)) {
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"`download <url> as <ver>` is no longer supported",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 169, className : "lix.cli.Cli", methodName : "dispatch"}))));
				} else {
					...
					return tink_core__$Promise_Promise_$Impl_$.noise(tink_core__$Promise_Promise_$Impl_$.next(libs.downloadUrl(tink__$Url_Url_$Impl_$.fromString(url4),{ into : target}),function(a) {
						...
						return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(a)));
					}));
				}
				break;
			case "into":
	...
	var this14 = new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("run"),"lib ...args","run a library",function(args8) {
		if(args8.length == 0) {
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"no library specified",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 202, className : "lix.cli.Cli", methodName : "dispatch"}))));
		} else {
			var args9 = args8;
	...
	var this15 = new lix_cli_Command(["--version","-v"],"","print version",function(args10) {
		if(args10.length > 0) {
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 208, className : "lix.cli.Cli", methodName : "dispatch"}))));
		} else {
			process.stdout.write(Std.string(version));
			process.stdout.write("\n");
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(tink_core_Noise.Noise)));
		}
	});
	lix_cli_Command.dispatch(args,this2,[this3,this7,this8,this9,this10,this11,this12,this14,this15,new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("run-haxelib"),"path ...args","invoke a haxelib at a given path following haxelib's conventions",function(args11) {
		if(args11.length == 0) {
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"no path supplied",{ fileName : "src/lix/cli/Cli.hx", lineNumber : 216, className : "lix.cli.Cli", methodName : "dispatch"}))));
		} else {
...
lix_cli__$Command_CommandExpander_$Impl_$.make = function(prefix,rule) {
	...
	var apply = function(args1) {
		...
		var _g4 = _g1.join("").split(" ");
		while(_g3 < _g4.length) {
			var res = _g4[_g3];
			++_g3;
			var _g31 = StringTools.trim(res);
			var apply1;
			if(_g31 == "") {
				continue;
			} else {
...
lix_cli_Command.dispatch = function(args,title,commands,extras) {
	var _g = args.shift();
	if(_g == null) {
		process.stdout.write(Std.string(title));
		process.stdout.write("\n");
		process.stdout.write("");
		process.stdout.write("\n");
		var prefix = 0;
		...
		process.stdout.write("\n");
		var _g15 = 0;
		while(_g15 < commands.length) {
			var c3 = commands[_g15];
			++_g15;
		...
		return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(404,"unknown command " + command,{ fileName : "src/lix/cli/Command.hx", lineNumber : 193, className : "lix.cli.Command", methodName : "dispatch"}))));
	}
};
...
var lix_client_ArchiveKind = $hxEnums["lix.client.ArchiveKind"] = { __ename__ : "lix.client.ArchiveKind", __constructs__ : ["Zip","Tar","Custom"]
	,Zip: {_hx_index:0,__enum__:"lix.client.ArchiveKind",toString:$estr}
	,Tar: {_hx_index:1,__enum__:"lix.client.ArchiveKind",toString:$estr}
	,Custom: ($_=function(load) { return {_hx_index:2,load:load,__enum__:"lix.client.ArchiveKind",toString:$estr}; },$_.__params__ = ["load"],$_)
};
var lix_client_ArchiveDestination = $hxEnums["lix.client.ArchiveDestination"] = { __ename__ : "lix.client.ArchiveDestination", __constructs__ : ["Fixed","Computed"]
	,Fixed: ($_=function(path) { return {_hx_index:0,path:path,__enum__:"lix.client.ArchiveDestination",toString:$estr}; },$_.__params__ = ["path"],$_)
	,Computed: ($_=function(f) { return {_hx_index:1,f:f,__enum__:"lix.client.ArchiveDestination",toString:$estr}; },$_.__params__ = ["f"],$_)
};
...
lix_client_DownloadedArchive.escape = function(s) {
	...
	var _g = 0;
	var _g1 = lix_client_DownloadedArchive.RESERVED.length;
	while(_g < _g1) {
		var i = _g++;
...
lix_client_DownloadedArchive.fresh = function(tmpLoc,storageRoot,targetLoc,job) {
	...
	var archive = null;
	var old = haxe_io_Path.removeTrailingSlashes("" + ret.storageRoot + "/" + ret.relRoot);
	...
	if(files.indexOf("haxelib.json") != -1) {
		...
		if(_g1 == null) {
			...
			while(_g21 < _g31.length) {
				...
				var tmp1;
				if(_g22 == null) {
					_hx_tmp = tink__$Url_Url_$Impl_$.fromString(_g22).scheme;
					if(_hx_tmp == null) {
						var version = _g22;
		...
		return new lix_client_ArchiveInfos(info1.name,info1.version,guessClassPath(),function(_) {
			return haxe_ds_Option.None;
		},[],null,null);
	} else {
		var o = lib.name;
		...
		return new lix_client_ArchiveInfos(_g12,_g5,guessClassPath(),function(_1) {
			return haxe_ds_Option.None;
		},[],null,null);
	}
};
...
lix_client_Download.text = function(url) {
	return tink_core__$Promise_Promise_$Impl_$.next(lix_client_Download.bytes(url),function(b) {
		return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(b.toString())));
	});
};
...
lix_client_Download.unzip = function(src,into,peel,res,events) {
	tink_core__$Promise_Promise_$Impl_$.next(lix_client_Download.buffered(res),function(bytes) {
		return tink_core__$Future_Future_$Impl_$.async(function(cb) {
			...
			if(pos == 0) {
				var this1 = tink_core_Outcome.Failure(new tink_core_TypedError(422,"Unzip failed to find central directory in " + src,{ fileName : "src/lix/client/Download.hx", lineNumber : 70, className : "lix.client.Download", methodName : "unzip"}));
				cb(this1);
				return;
			}
			var data = bytes.b;
			lix_client_uncompress_Yauzl.fromBuffer(js_node_buffer_Buffer.from(data.buffer,data.byteOffset,bytes.length),function(err,zip) {
				var saved = -1;
				var done = function() {
					saved += 1;
				...
				if(err != null) {
					var this2 = tink_core_Outcome.Failure(new tink_core_TypedError(422,"Failed to unzip " + src + " because " + Std.string(err),{ fileName : "src/lix/client/Download.hx", lineNumber : 83, className : "lix.client.Download", methodName : "unzip"}));
					cb(this2);
				}
					...
					case 0:
						...
						if(StringTools.endsWith(path,"/")) {
							...
							zip.openReadStream(entry,function(e,stream) {
								var out = require("graceful-fs").createWriteStream(path);
...
lix_client_Download.untar = function(src,into,peel,res,events) {
	return tink_core__$Future_Future_$Impl_$.async(function(cb) {
			...
			haxe_Timer.delay(function() {
				if((pending -= 1) <= 0) {
								...
								js_node_Fs.unlink(link1[0].to,(function(link2) {
									return function(_) {
										js_node_Fs.symlink(link2[0].from,link2[0].to,(function() {
											return function(e) {
												var this1 = e == null ? tink_core_Outcome.Success(tink_core_Noise.Noise) : tink_core_Outcome.Failure(new tink_core_TypedError(null,e.message,{ fileName : "src/lix/client/Download.hx", lineNumber : 130, className : "lix.client.Download", methodName : "untar"}));
												cb1(this1);
											};
										})());
									};
					...
					tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.inParallel(_g),function(_1) {
						return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(into)));
					}).handle(cb);
				}
			},100);
		};
		...
		var fail = function(message) {
			error = new tink_core_TypedError(null,message,{ fileName : "src/lix/client/Download.hx", lineNumber : 142, className : "lix.client.Download", methodName : "untar"});
			...
			case 0:
				...
				if(StringTools.endsWith(path,"/")) {
					...
					if(entry.type == "SymbolicLink") {
						...
						var out = require("graceful-fs").createWriteStream(path,{ mode : entry.mode});
...
lix_client_Download.download = function(url,handler) {
	return tink_core__$Future_Future_$Impl_$.async(function(cb) {
		...
		var fail = function(e) {
			var fail1 = tink_core_Outcome.Failure(tink_core_TypedError.withData(null,"Failed to download " + url + " because " + e.message,e,{ fileName : "src/lix/client/Download.hx", lineNumber : 287, className : "lix.client.Download", methodName : "download"}));
			cb(fail1);
		};
		...
		req.on("response",function(res) {
			if(res.statusCode >= 400) {
				var tmp = tink_core_Outcome.Failure(tink_core_TypedError.withData(res.statusCode,res.statusMessage,res,{ fileName : "src/lix/client/Download.hx", lineNumber : 298, className : "lix.client.Download", methodName : "download"}));
				cb(tmp);
			} else {
				...
				if(_g == null) {
					...
					var _g12 = _g1.slashes;
					var _g11 = _g1.search;
					var _g10 = _g1.query;
					var _g8 = _g1.port;
					var _g7 = _g1.pathname;
					var _g6 = _g1.path;
					var _g5 = _g1.href;
					var _g4 = _g1.hostname;
					var _g3 = _g1.host;
					var _g2 = _g1.hash;
					var _g13 = _g1.auth;
...
lix_client_Libraries.prototype = {
	...
	,downloadArchive: function(a,__tink_tmp11) {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(a,function(a1) {
			...
			if(exists && !_gthis.force) {
				...
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(lix_client_DownloadedArchive.existent(into,_gthis.scope.libCache,a1))));
			} else {
				...
				return tink_core__$Promise_Promise_$Impl_$.next(tmp,function(dir) {
					...
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(ret)));
				});
			}
		});
	}
	,installMany: function(projects) {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(this.resolver(projects),function(jobs) {
			...
			while(_g < jobs.length) {
				var j = jobs[_g];
				++_g;
				var tmp = new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(j)));
				__tmp.push(_gthis.installArchive(tmp));
			}
	...
	,installArchive: function(a,as,withHaxeLibDependencies) {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(this.downloadArchive(a),function(a1) {
			var extra;
			var found = "" + haxe_io_Path.removeTrailingSlashes("" + a1.storageRoot + "/" + a1.relRoot) + "/extraParams.hxml";
			...
			if(name == null) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Could not determine library name for " + tink__$Url_Url_$Impl_$.toString(a1.job.normalized),{ fileName : "src/lix/client/Libraries.hx", lineNumber : 103, className : "lix.client.Libraries", methodName : "installArchive"}))));
			}
			...
			var saveHxml = function(value) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_TypedError.catchExceptions(function() {
					...
					return value;
				},null,{ fileName : "src/lix/client/Libraries.hx", lineNumber : 142, className : "lix.client.Libraries", methodName : "installArchive"})));
			};
			saveHxml();
			var __tmp1 = [];
			...
			return tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Future_Future_$Impl_$.next(tink_core__$Future_Future_$Impl_$.ofMany(__tmp1),function(results) {
				...
				while(iterator___tink_tmp4.hasNext()) {
					...
					if(__tink_tmp4._hx_index == 1) {
						var e = __tink_tmp4.failure;
						__tmp2.push(e);
					}
				}
				var _g11 = __tmp2;
				if(_g11.length == 0) {
					...
					var errors = _g11;
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(tink_core_TypedError.withData(null,"Failed to install dependencies:\n  " + errors.map(function(e1) {
						return e1.message;
					}).join("\n  "),errors,{ fileName : "src/lix/client/Libraries.hx", lineNumber : 187, className : "lix.client.Libraries", methodName : "installArchive"}))));
				}
			}),function(_1) {
...
var lix_client_haxe_ResolvedUserVersionData = $hxEnums["lix.client.haxe.ResolvedUserVersionData"] = { __ename__ : "lix.client.haxe.ResolvedUserVersionData", __constructs__ : ["RNightly","ROfficial","RCustom"]
	,RNightly: ($_=function(nightly) { return {_hx_index:0,nightly:nightly,__enum__:"lix.client.haxe.ResolvedUserVersionData",toString:$estr}; },$_.__params__ = ["nightly"],$_)
	,ROfficial: ($_=function(version) { return {_hx_index:1,version:version,__enum__:"lix.client.haxe.ResolvedUserVersionData",toString:$estr}; },$_.__params__ = ["version"],$_)
	,RCustom: ($_=function(path) { return {_hx_index:2,path:path,__enum__:"lix.client.haxe.ResolvedUserVersionData",toString:$estr}; },$_.__params__ = ["path"],$_)
};
...
lix_client_haxe__$ResolvedVersion_ResolvedVersion_$Impl_$.get_id = function(this1) {
	...
	case 0:
		var _g = this1.nightly;
		var _g2 = _g.published;
		var v = _g.hash;
		return v;
	case 1:
		var v1 = this1.version;
		return v1;
	case 2:
		var v2 = this1.path;
		return v2;
...
var lix_client_haxe_PickOfficial = $hxEnums["lix.client.haxe.PickOfficial"] = { __ename__ : "lix.client.haxe.PickOfficial", __constructs__ : ["StableOnly","IncludePrereleases"]
	,StableOnly: {_hx_index:0,__enum__:"lix.client.haxe.PickOfficial",toString:$estr}
	,IncludePrereleases: {_hx_index:1,__enum__:"lix.client.haxe.PickOfficial",toString:$estr}
};
...
lix_client_haxe_Switcher.officialOnline = function(kind) {
	return tink_core__$Promise_Promise_$Impl_$.next(lix_client_Download.text("https://raw.githubusercontent.com/HaxeFoundation/haxe.org/staging/downloads/versions.json"),function(s) {
		...
		return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(lix_client_haxe_Switcher.sortedOfficial(kind,d))));
	});
};
		...
		while(_g < lines.length) {
			...
			if(_g1 != "") {
				...
				if(v.indexOf("_development_") != -1) {
					...
					var _hx_tmp;
					if(_g2 != -1) {
						_hx_tmp = HxOverrides.substr(v,0,_g2).split(" ");
						if(_hx_tmp.length == 2) {
							var _g21 = _hx_tmp[1];
							...
							if(_hx_tmp1.length == 3) {
								...
								if(_g3 == null) {
									if(_g4 == null) {
										if(_g5 == null) {
											var _hx_tmp2 = _g21.split(":").map(Std.parseInt);
											...
											var _hx_tmp3 = _g21.split(":").map(Std.parseInt);
										...
										var _hx_tmp4 = _g21.split(":").map(Std.parseInt);
										...
										var _hx_tmp5 = _g21.split(":").map(Std.parseInt);
									...
									if(_g5 == null) {
										var _hx_tmp6 = _g21.split(":").map(Std.parseInt);
										...
										var _hx_tmp7 = _g21.split(":").map(Std.parseInt);
									...
									var _hx_tmp8 = _g21.split(":").map(Std.parseInt);
									...
									var _hx_tmp9 = _g21.split(":").map(Std.parseInt);
...
lix_client_haxe_Switcher.attempt = function(what,l) {
	try {
		return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(l.get())));
	} catch( e ) {
		return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Failed to " + what + " because " + Std.string(((e) instanceof js__$Boot_HaxeError) ? e.val : e),{ fileName : "src/lix/client/haxe/Switcher.hx", lineNumber : 107, className : "lix.client.haxe.Switcher", methodName : "attempt"}))));
	}
};
lix_client_haxe_Switcher.pickFirst = function(kind,make) {
	return function(i) {
		...
		if(_g == null) {
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(404,"No " + kind + " build found",{ fileName : "src/lix/client/haxe/Switcher.hx", lineNumber : 138, className : "lix.client.haxe.Switcher", methodName : "pickFirst"}))));
		} else {
			var v = _g;
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(make(v))));
		}
	};
};
lix_client_haxe_Switcher.ensureNeko = function(echo) {
	...
	if(sys_FileSystem.exists(neko)) {
		return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(neko)));
	} else {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(tmp,function(x) {
			echo("done");
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(x)));
		});
	}
};
lix_client_haxe_Switcher.prototype = {
		...
		case 3:
			...
			return tink_core__$Promise_Promise_$Impl_$.ofSpecific(tink_core__$Promise_Promise_$Impl_$.next(getNightlies(),function(v) {
				...
				while(n.hasNext()) {
					var n1 = n.next();
					if(n1.hash == hash) {
						return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(lix_client_haxe_ResolvedUserVersionData.RNightly(n1))));
					}
				}
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(404,"Unable to resolve nightly version " + lix_client_haxe__$UserVersion_UserVersion_$Impl_$.toString(version) + " locally, install it first with `lix install haxe " + lix_client_haxe__$UserVersion_UserVersion_$Impl_$.toString(version) + "`",{ fileName : "src/lix/client/haxe/Switcher.hx", lineNumber : 163, className : "lix.client.haxe.Switcher", methodName : "resolve"}))));
			}));
		case 4:
			...
			return tink_core__$Promise_Promise_$Impl_$.ofSpecific(tink_core__$Promise_Promise_$Impl_$.next(getOfficial(lix_client_haxe_PickOfficial.IncludePrereleases),function(versions) {
				if(Lambda.has(versions,version1)) {
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(lix_client_haxe_ResolvedUserVersionData.ROfficial(version1))));
				} else {
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(404,"Unable to resolve version " + version1 + " locally, install it first with `lix install haxe " + version1 + "`",{ fileName : "src/lix/client/haxe/Switcher.hx", lineNumber : 171, className : "lix.client.haxe.Switcher", methodName : "resolve"}))));
				}
			}));
		case 5:
			var path = version.path;
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(lix_client_haxe_ResolvedUserVersionData.RCustom(path))));
		}
	}
	...
	,resolveAndDownload: function(version,options) {
		...
		case 4:
			...
			break;
		default:
			this1 = new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"" + version + " needs to be resolved online",{ fileName : "src/lix/client/haxe/Switcher.hx", lineNumber : 229, className : "lix.client.haxe.Switcher", methodName : "resolveAndDownload"}))));
		}
		var f = function(_) {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(ret.gather(),function(r1) {
			return tink_core__$Promise_Promise_$Impl_$.next(_gthis.download(r1,options),function(wasDownloaded) {
				...
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(r1)));
			});
		});
	}
	,download: function(version,options) {
		...
		case 1:
			...
			break;
		case 2:
			var _g5 = version.path;
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Cannot download custom version",{ fileName : "src/lix/client/haxe/Switcher.hx", lineNumber : 260, className : "lix.client.haxe.Switcher", methodName : "download"}))));
		}
	}
...
var lix_client_haxe_UserVersionData = $hxEnums["lix.client.haxe.UserVersionData"] = { __ename__ : "lix.client.haxe.UserVersionData", __constructs__ : ["UEdge","ULatest","UStable","UNightly","UOfficial","UCustom"]
	,UEdge: {_hx_index:0,__enum__:"lix.client.haxe.UserVersionData",toString:$estr}
	,ULatest: {_hx_index:1,__enum__:"lix.client.haxe.UserVersionData",toString:$estr}
	,UStable: {_hx_index:2,__enum__:"lix.client.haxe.UserVersionData",toString:$estr}
	,UNightly: ($_=function(hash) { return {_hx_index:3,hash:hash,__enum__:"lix.client.haxe.UserVersionData",toString:$estr}; },$_.__params__ = ["hash"],$_)
	,UOfficial: ($_=function(version) { return {_hx_index:4,version:version,__enum__:"lix.client.haxe.UserVersionData",toString:$estr}; },$_.__params__ = ["version"],$_)
	,UCustom: ($_=function(path) { return {_hx_index:5,path:path,__enum__:"lix.client.haxe.UserVersionData",toString:$estr}; },$_.__params__ = ["path"],$_)
};
...
lix_client_sources_Git.eval = function(cmd,cwd,args,env) {
	...
	if(x.error == null) {
		...
		var _g2 = _g.output;
		var e = _g.error;
		return tink_core_Outcome.Failure(new tink_core_TypedError(null,"Failed to call " + cmd + " because " + Std.string(e),{ fileName : "src/lix/client/sources/Git.hx", lineNumber : 25, className : "lix.client.sources.Git", methodName : "eval"}));
	}
};
	...
	return { call : function(args) {
		return tink_core__$Promise_Promise_$Impl_$.next(new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(haxeshim_Exec.sync("git",cwd,args))),function(code) {
			if(code == 0) {
				...
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(code,"git " + args[0] + " failed",{ fileName : "src/lix/client/sources/Git.hx", lineNumber : 33, className : "lix.client.sources.Git", methodName : "cli"}))));
			}
		});
	}, 'eval' : function(args1) {
		return tink_core__$Promise_Promise_$Impl_$.next(new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(lix_client_sources_Git.eval("git",cwd,args1))),function(o) {
			var _g1 = o.stdout;
			if(o.status == 0) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(o.stdout.toString())));
			} else {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(o.status,"git " + args1[0] + " failed",{ fileName : "src/lix/client/sources/Git.hx", lineNumber : 40, className : "lix.client.sources.Git", methodName : "cli"}))));
			}
		});
	}};
};
	...
	,processUrl: function(raw) {
		...
		if(StringTools.startsWith(gh,"https://github.com")) {
			...
			if(StringTools.startsWith(gl,"https://gitlab.com")) {
				...
				var url = tink__$Url_Url_$Impl_$.fromString(_g);
				...
				var sha = version.length != 40 ? tink_core__$Promise_Promise_$Impl_$.next(git.eval(["ls-remote",tink__$Url_Url_$Impl_$.toString(origin),version]),function(s) {
					...
					if(_g11 == "") {
						return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Cannot resolve version " + version,{ fileName : "src/lix/client/sources/Git.hx", lineNumber : 73, className : "lix.client.sources.Git", methodName : "processUrl"}))));
					} else {
						var v5 = _g11;
						return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(HxOverrides.substr(v5,0,40))));
					}
				}) : new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(version)));
				return tink_core__$Promise_Promise_$Impl_$.next(sha,tink_core__$Promise_Next_$Impl_$.ofSafeSync(function(sha1) {
					...
					var tmp7 = lix_client_ArchiveKind.Custom(function(ctx) {
						...
						return tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.next(git2.call(tmp8),function(_) {
							...
							return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(ctx.dest)));
						});
					});
...
lix_client_sources_GitHub.prototype = {
	...
	,grabCommit: function(owner,project,version) {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(lix_client_Download.text("https://" + (this1 == null ? "" : "" + this1 + "@") + "api.github.com/repos/" + owner + "/" + project + "/commits?sha=" + version),function(s) {
			try {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(JSON.parse(s)[0].sha)));
			} catch( e ) {
				var e1 = ((e) instanceof js__$Boot_HaxeError) ? e.val : e;
				var s1;
				if(version == null) {
				...
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Failed to lookup sha for github:" + owner + "/" + project + s1,{ fileName : "src/lix/client/sources/GitHub.hx", lineNumber : 25, className : "lix.client.sources.GitHub", methodName : "grabCommit"}))));
			}
		});
	}
	,getArchive: function(owner,project,commitish,credentials) {
		...
		if(commitish == null) {
			...
			var sha1 = commitish;
			if(sha1.length == 40) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success({ normalized : tink__$Url_Url_$Impl_$.fromString("gh://" + (credentials == null ? "" : "" + credentials + "@") + "github.com/" + owner + "/" + project + "#" + sha1), dest : lix_client_ArchiveDestination.Computed(function(l) {
	...
	,processUrl: function(url) {
		...
		var _hx_tmp;
		if(_g == null) {
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid github url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "src/lix/client/sources/GitHub.hx", lineNumber : 49, className : "lix.client.sources.GitHub", methodName : "processUrl"}))));
		} else {
			...
			if(_hx_tmp.length == 2) {
				...
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid github url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "src/lix/client/sources/GitHub.hx", lineNumber : 52, className : "lix.client.sources.GitHub", methodName : "processUrl"}))));
			}
		}
	}
...
lix_client_sources_GitLab.prototype = {
	...
	,grabCommit: function(owner,project,version,options) {
		return tink_core__$Promise_Promise_$Impl_$.next(lix_client_Download.text("https://" + lix_client_sources_GitLab.host(options) + "/api/v4/projects/" + owner + "%2F" + project + "/repository/commits/" + version + "?" + this.privateToken),function(s) {
			try {
				...
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success(parsed.id)));
			} catch( e ) {
				var e1 = ((e) instanceof js__$Boot_HaxeError) ? e.val : e;
				var s1;
				if(version == null) {
				...
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Failed to lookup sha for gitlab:" + owner + "/" + project + s1,{ fileName : "src/lix/client/sources/GitLab.hx", lineNumber : 35, className : "lix.client.sources.GitLab", methodName : "grabCommit"}))));
			}
		});
	}
	,getArchive: function(owner,project,commitish,options) {
		if(commitish == null) {
			...
			var sha = commitish;
			if(sha.length == 40) {
				var url = "https://" + lix_client_sources_GitLab.host(options) + "/api/v4/projects/" + owner + "%2F" + project + "/repository/archive.zip?sha=" + sha + "&" + this.privateToken;
				var d = lix_client_ArchiveDestination.Computed(function(l) {
					return [l.name,l.version,"gitlab",sha];
				});
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success({ normalized : tink__$Url_Url_$Impl_$.fromString(url), dest : d, url : tink__$Url_Url_$Impl_$.fromString(url), lib : new lix_client_LibVersion(haxe_ds_Option.Some(project),haxe_ds_Option.None)})));
			} else {
				var v = commitish;
	...
	,processUrl: function(url) {
		...
		var _hx_tmp;
		if(_g == null) {
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid gitlab url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "src/lix/client/sources/GitLab.hx", lineNumber : 57, className : "lix.client.sources.GitLab", methodName : "processUrl"}))));
		} else {
			_hx_tmp = tink_url__$PortionArray_PortionArray_$Impl_$.toStringArray(tink_url__$Path_Path_$Impl_$.parts(_g));
			if(_hx_tmp.length == 2) {
				var project = _hx_tmp[1];
				...
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid gitlab url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "src/lix/client/sources/GitLab.hx", lineNumber : 59, className : "lix.client.sources.GitLab", methodName : "processUrl"}))));
			}
		}
	}
...
lix_client_sources_Haxelib.prototype = {
	...
	,processUrl: function(url) {
		...
		if((_g == null || _g == this.baseURL) == true) {
			var _g1 = url.path;
			var _hx_tmp;
			if(_g1 == null) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid haxelib url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "src/lix/client/sources/Haxelib.hx", lineNumber : 32, className : "lix.client.sources.Haxelib", methodName : "processUrl"}))));
			} else {
				_hx_tmp = tink_url__$PortionArray_PortionArray_$Impl_$.toStringArray(tink_url__$Path_Path_$Impl_$.parts(_g1));
				if(_hx_tmp.length == 1) {
					var v = _hx_tmp[0];
					return this.getArchive(v,url.hash,{ host : url.host});
				} else {
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid haxelib url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "src/lix/client/sources/Haxelib.hx", lineNumber : 34, className : "lix.client.sources.Haxelib", methodName : "processUrl"}))));
				}
			}
		} else {
			var v1 = _g;
	...
	,getArchive: function(name,version,options) {
		if(version == null) {
			...
			return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success({ url : d, normalized : d2, dest : lix_client_ArchiveDestination.Fixed([name,version,"haxelib" + d3]), kind : lix_client_ArchiveKind.Zip, lib : new lix_client_LibVersion(haxe_ds_Option.Some(name),haxe_ds_Option.Some(version))})));
		}
	}
	,resolveVersion: function(name,options) {
		...
		return tink_core__$Future_Future_$Impl_$.async(function(cb) {
			...
			cnx.setErrorHandler(function(e) {
				var tmp = tink_core_Outcome.Failure(tink_core_TypedError.withData(null,"Failed to get version information from haxelib because " + e,e,{ fileName : "src/lix/client/sources/Haxelib.hx", lineNumber : 74, className : "lix.client.sources.Haxelib", methodName : "resolveVersion"}));
				cb(tmp);
			});
...
lix_client_sources_Web.processUrl = function(url) {
	...
	return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_Outcome.Success({ url : url, dest : d, normalized : url, lib : lib})));
};
...
lix_client_uncompress_Tar.parse = function(source,onentry) {
	return tink_core__$Future_Future_$Impl_$.async(function(cb) {
		...
		parse.on("error",function(e) {
			var tmp = tink_core_Outcome.Failure(new tink_core_TypedError(null,e.message,{ fileName : "src/lix/client/uncompress/Tar.hx", lineNumber : 14, className : "lix.client.uncompress.Tar", methodName : "parse"}));
			cb(tmp);
		});
	});
};
...
var tink_semver_Bound = $hxEnums["tink.semver.Bound"] = { __ename__ : "tink.semver.Bound", __constructs__ : ["Unbounded","Exlusive","Inclusive"]
	,Unbounded: {_hx_index:0,__enum__:"tink.semver.Bound",toString:$estr}
	,Exlusive: ($_=function(limit) { return {_hx_index:1,limit:limit,__enum__:"tink.semver.Bound",toString:$estr}; },$_.__params__ = ["limit"],$_)
	,Inclusive: ($_=function(limit) { return {_hx_index:2,limit:limit,__enum__:"tink.semver.Bound",toString:$estr}; },$_.__params__ = ["limit"],$_)
};
...
var tink_semver_ExtremumKind = $hxEnums["tink.semver.ExtremumKind"] = { __ename__ : "tink.semver.ExtremumKind", __constructs__ : ["Upper","Lower"]
	,Upper: {_hx_index:0,__enum__:"tink.semver.ExtremumKind",toString:$estr}
	,Lower: {_hx_index:1,__enum__:"tink.semver.ExtremumKind",toString:$estr}
};
	...
	while(_g < ranges.length) {
		...
		case 0:
			...
			while(_g2 < merged.length) {
				var old = merged[_g2];
				++_g2;
				var _g3 = tink_semver_RangeTools.merge(old,nu);
				switch(_g3._hx_index) {
				case 0:
					var v = _g3.v;
					nu = v;
	...
	if(a == null) {
		...
		while(a1.hasNext()) {
			...
			_hx_loop2: while(b1.hasNext()) {
				var b2 = b1.next();
				var _g2 = tink_semver_RangeTools.intersect(res,b2);
				switch(_g2._hx_index) {
				case 0:
					var c = _g2.v;
					res = c;
...
tink_semver_Parser.prototype = $extend(tink_parse_ParserBase.prototype,{
	...
	,parsePartial: function() {
		...
		var range_min1 = start2;
		var range_max1 = this.pos;
		...
		if(patch >= 0 && this.allowHere(tink_semver_Parser.HYPHEN)) {
			...
			while(true) {
				...
				if(this.pos < this.max) {
					...
					preview1 = cond2 == null || cond2(value2);
				} else {
					preview1 = false;
				}
				if(!preview1) {
			...
			var range_min2 = start3;
			var range_max2 = this.pos;
			...
			if(this.allowHere(tink_semver_Parser.DOT)) {
				...
				while(true) {
					...
					if(this.pos < this.max) {
						...
						previewNum1 = cond3 == null || cond3(value3);
					} else {
						previewNum1 = false;
					}
					if(!previewNum1) {
				...
				var range_min3 = start4;
				var range_max3 = this.pos;
	...
	,makeError: function(message,pos) {
		var this1 = this.source;
		return new tink_core_TypedError(null,"" + message + " at " + ("\"" + tink_parse__$StringSlice_StringSlice_$Impl_$._new(this1.string,tink_parse__$StringSlice_StringSlice_$Impl_$.wrap(this1,pos.min) + this1.start,tink_parse__$StringSlice_StringSlice_$Impl_$.clamp(this1,pos.max) + this1.start).toString() + "\"(" + pos.min + "-" + pos.max + ")") + (" in \"" + this.source.toString() + "\""),{ fileName : "tink/semver/Parser.hx", lineNumber : 145, className : "tink.semver.Parser", methodName : "makeError"});
	}
	,doMakePos: function(from,to) {
...
"d5uTetZgKLE4NlaEUKnUQLfDM8k322IVcpsyjJraHh8=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"eoK0D62GlgRHrI4zTjuWAEy/LMqZsyLC8Fo8GU+kISc=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"ffSl0Po+oEfSBDuRHmOUfVIRxtwVC+q1s4oDnc/owLA=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"gSpuutX9XBYT4rMRn6u+1xj0OaGejPi09QG0jK2AVjE=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"ioWFW10oMSwDvoKPU50rrmVYltQos0sjtUJQgHRfEYE=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"mQS2OWB9sSqEsYSUZeuO13UG/8bgCPkMJyrGj+Pc7ng=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"mmvmyafgoMNYUMZfch67lCuRZPxoMSS+4akeuBEGKs8=":
function (require, module, exports, __dirname, __filename) {
var fs = require('fs')
...
"qyopPBneiAbPmTkJnJZgCpI+FKAQsv27ElP2G8OlI34=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
,
{
  ...
  "node_modules/graceful-fs/graceful-fs.js": [
    "mmvmyafgoMNYUMZfch67lCuRZPxoMSS+4akeuBEGKs8=",
    {
      "./clone.js": "node_modules/graceful-fs/clone.js",
  ...
  "node_modules/tar/lib/header.js": [
    "gSpuutX9XBYT4rMRn6u+1xj0OaGejPi09QG0jK2AVjE=",
    {
      "./buffer.js": "node_modules/tar/lib/buffer.js",
  ...
  "node_modules/tar/lib/write-entry.js": [
    "/GbaawVQXxcESYBNDHqcwH8S/5p7PvQU6oeljp8mBOk=",
    {
      "./buffer.js": "node_modules/tar/lib/buffer.js",
      "./header.js": "node_modules/tar/lib/header.js",
      "./mode-fix.js": "node_modules/tar/lib/mode-fix.js",
      "./pax.js": "node_modules/tar/lib/pax.js",
      "./read-entry.js": "node_modules/tar/lib/read-entry.js",
      "./types.js": "node_modules/tar/lib/types.js",
      "./warn-mixin.js": "node_modules/tar/lib/warn-mixin.js",
